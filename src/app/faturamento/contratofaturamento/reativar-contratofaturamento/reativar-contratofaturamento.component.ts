...
@Component({
  selector: 'app-reativar-contratofaturamento',
  templateUrl: './reativar-contratofaturamento.component.html',
  providers: [MaskService],
  styleUrls: []

})

export class ReativarContratoFaturamentoComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    this.swal.showSwalConfirm('Reativação', function (isConfirmed) {
      if (isConfirmed) {
        self.reativarContratoFaturamento();
      }
      else {
        self.cancelar();
      }
  ...
  reativarContratoFaturamento() {
    this.contratoFaturamentoService.reativarContratoFaturamento(this.contratoFaturamento)
    .subscribe(
    () => { 
      this.swal.showSwalSuccess('Contrato Faturamento reativado com sucesso!');
