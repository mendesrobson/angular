...
@Component({
  selector: 'app-excluir-tipoendereco',
  templateUrl: './excluir-tipoendereco.component.html',
  styleUrls: []
})
export class ExcluirTipoenderecoComponent implements OnInit, AfterViewInit {
    [x: string]: any;
    ...
    removerTipoEndereco() {
      this.tipoEnderecoService.RemoverTipoEndereco(this.tipoEndereco)
        .subscribe(
        result => {
          this.swal.showSwalSuccess('Tipo de Endereco, Removido com Sucesso');
