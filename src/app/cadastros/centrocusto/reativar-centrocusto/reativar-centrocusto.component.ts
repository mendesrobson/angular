...
@Component({
  selector: 'app-reativar-centrocusto',
  templateUrl: './reativar-centrocusto.component.html',
  providers: [MaskService],
  styleUrls: []
})

export class ReativarCentrocustoComponent implements OnInit, AfterViewInit {
  [x: string]: any;
  ...
  reativarCentroCusto() {
    this.centroCustoService.ReativarCentroCusto(this.centroCusto)
    .subscribe(
    result => { 
      this.swal.showSwalSuccess('Centro Custo, reativado com sucesso!');
