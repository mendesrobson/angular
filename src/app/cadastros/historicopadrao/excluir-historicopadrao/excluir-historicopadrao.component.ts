...
@Component({
  selector: 'app-excluir-historicopadrao',
  templateUrl: './excluir-historicopadrao.component.html',
  styleUrls: []
})
export class ExcluirHistoricopadraoComponent implements OnInit, AfterViewInit {
  ...
  removerHistoricoPadrao() {
    this.historicoPadraoService.RemoverHistoricoPadrao(this.historicoPadrao)
    .subscribe(
    result => { 
      this.swal.showSwalSuccess('Histórico Padrão Removido com Sucesso');
