...
@Component({
  selector: 'app-lista-historicocentroresultado',
  templateUrl: './lista-historicocentroresultado.component.html',
  styleUrls: []
})
export class ListaHistoricocentroresultadoComponent implements OnInit {
  ...
  constructor(public historicoPadraoService: HistoricoPadraoService,
    ...
    public historicoPadraoComponent: HistoricopadraoComponent) {
  ...
  editarHistoricoPadraoResultado(centroResultado) {
    this.historicoPadraoComponent.HistoricoPadraoCentro = centroResultado;
