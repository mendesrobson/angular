...
@Component({
  selector: 'app-reativar-tipologradouro',
  templateUrl: './reativar-tipologradouro.component.html',
  styleUrls: []
})

export class ReativarTipologradouroComponent implements OnInit, AfterViewInit {
  [x: string]: any;
  ...
  reativarTipoLogradouro() {
    this.tipoLogradouroService.ReativarTipoLogradouro(this.tipoLogradouro)
      .subscribe(
        result => {
          this.swal.showSwalSuccess('Tipo de Logradouro Reativado com Sucesso')
