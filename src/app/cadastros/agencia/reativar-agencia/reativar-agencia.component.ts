...
@Component({
  selector: 'app-reativar-agencia',
  templateUrl: './reativar-agencia.component.html',
  providers: [MaskService],
  styleUrls: []
})

export class ReativarAgenciaComponent implements OnInit, AfterViewInit {
  [x: string]: any;
  ...
  reativarAgencia() {
    this.agenciaService.ReativarAgencia(this.agencia)
      .subscribe(
        result => {
          this.swal.showSwalSuccess('Agencia reativada com sucesso!');
