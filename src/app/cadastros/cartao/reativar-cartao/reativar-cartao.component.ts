...
@Component({
  selector: 'app-reativar-cartao',
  templateUrl: './reativar-cartao.component.html',
  providers: [MaskService],
  styleUrls: []
})

export class ReativarCartaoComponent implements OnInit, AfterViewInit {
    [x: string]: any;
  ...
  reativarCartao() {
    this.cartaoService.ReativarCartao(this.cartao)
    .subscribe(
    result => { 
      this.swal.showSwalSuccess('Cartão, reativado com sucesso!');
  ...
  cancelar() {
    this.router.navigate(['cartao/editar/' + this.cartaoId]);
  }
