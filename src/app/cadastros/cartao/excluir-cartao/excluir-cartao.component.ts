...
export class ExcluirCartaoComponent implements OnInit, AfterViewInit {
    [x: string]: any;
  ...
  removerCartao() {
    this.cartaoService.RemoverCartao(this.cartao)
      .subscribe(
      result => {
        this.swal.showSwalSuccess('Cartão, removido com Sucesso');
