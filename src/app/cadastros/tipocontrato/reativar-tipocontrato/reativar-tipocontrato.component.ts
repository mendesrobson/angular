...
import { Periodicidade, TipoReajuste, Indice, Mes, Indexador, TipoContrato } from '../models/tipocontrato';
...
@Component({
  selector: 'app-reativar-tipocontrato',
  templateUrl: './reativar-tipocontrato.component.html',
  styleUrls: []
})
export class ReativarTipoContratoComponent implements OnInit, AfterViewInit {
  ...
  reativarTipoContrato() {
    this.tipoContratoService.reativarTipoContrato(this.tipoContrato)
      .subscribe(
        result => {
          this.swal.showSwalSuccess('Tipo Contrato Reativado com Sucesso');
