...
@Component({
  selector: 'app-reativar-corraca',
  templateUrl: './reativar-corraca.component.html',
  styleUrls: []
})
export class ReativarCorRacaComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    reativarCorRaca() {
      this.corRacaService.ReativarCorRaca(this.corRaca)
        .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Cor/Raça reativado com sucesso!');
          } else {
