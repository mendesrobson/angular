...
@Component({
  selector: 'app-reativar-uf',
  templateUrl: './reativar-uf.component.html',
  styleUrls: []
})
export class ReativarUfComponent implements OnInit, AfterViewInit {
    [x: string]: any;
    ...
    reativarUf() {
      this.ufService.ReativarUf(this.uf)
        .subscribe(
        result => {
          this.swal.showSwalSuccess('Uf, Reativada com Sucesso')
