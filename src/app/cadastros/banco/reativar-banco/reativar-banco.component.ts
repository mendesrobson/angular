...
@Component({
  selector: 'app-reativar-banco',
  templateUrl: './reativar-banco.component.html',
  styleUrls: []
})
export class ReativarBancoComponent implements OnInit, AfterViewInit {
  ...
  reativarBanco() {
    this.bancoService.ReativarBanco(this.banco)
    .subscribe(
    result => { 
      this.swal.showSwalSuccess('Banco reativado com sucesso!');
