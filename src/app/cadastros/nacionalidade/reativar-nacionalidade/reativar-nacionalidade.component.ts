...
@Component({
  selector: 'app-reativar-nacionalidade',
  templateUrl: './reativar-nacionalidade.component.html',
  styleUrls: []
})

export class ReativarNacionalidadeComponent implements OnInit, AfterViewInit {
  ...
  reativarNacionalidade() {
    this.nacionalidadeService.reativarNacionalidade(this.nacionalidade)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Nacionalidade Reativada com Sucesso!');
          } else {
