...
@Component({
  selector: 'app-reativar-parentesco',
  templateUrl: './reativar-parentesco.component.html',
  styleUrls: []
})
export class ReativarParentescoComponent implements OnInit, AfterViewInit {
  ...
  reativarParentesco() {
    this.parentescoService.reativarParentesco(this.parentesco)
      .subscribe(
      result => {
        if (result) {
          this.swal.showSwalSuccess('Parentesco Reativado com Sucesso!');
        } else {
