...
@Component({
  selector: 'app-excluir-configuracaopagamento',
  templateUrl: './excluir-configuracaopagamento.component.html',
  providers: [MaskService],
  styleUrls: []
})

export class ExcluirConfiguracaopagamentoComponent implements OnInit, AfterViewInit {
  [x: string]: any;
  ...
  ngAfterViewInit(): void {
    let controlBlurs: Observable<any>[] = this.formInputElements
      ...
      this.swal.showSwalConfirm('Exclusão', function (isConfirmed) {
        if (isConfirmed) {
          self.removerConfiguracaoPagamento();
        }
        else {
          self.cancelar();
        }
  ...
  removerConfiguracaoPagamento() {
    this.configuracaoPagamentoService.RemoverConfiguracaoPagamento(this.configuracaoPagamento)
      .subscribe(
      result => {
        this.swal.showSwalSuccess('Configuração Pagamento, Removida com Sucesso');
