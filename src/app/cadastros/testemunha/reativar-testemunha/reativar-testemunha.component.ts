...
@Component({
  selector: 'app-reativar-testemunha',
  templateUrl: './reativar-testemunha.component.html',
  styleUrls: []
})
export class ReativarTestemunhaComponent implements OnInit, AfterViewInit {
  ...
  reativarTestemunha() {
    this.testemunhaService.reativarTestemunha(this.testemunha)
      .subscribe(
      result => {
        this.swal.showSwalSuccess('Testemunha Reativada com Sucesso')
