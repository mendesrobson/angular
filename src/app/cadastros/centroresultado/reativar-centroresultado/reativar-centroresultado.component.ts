...
@Component({
  selector: 'app-reativar-centroresultado',
  templateUrl: './reativar-centroresultado.component.html',
  providers: [MaskService],
  styleUrls: []
})

export class ReativarCentroresultadoComponent implements OnInit, AfterViewInit {
  [x: string]: any;
  ...
  reativarCentroResultado() {
    this.centroResultadoService.ReativarCentroResultado(this.centroResultado)
    .subscribe(
    result => { 
      this.swal.showSwalSuccess('Centro Resultado, reativado com sucesso!');
