...
@Component({
  selector: 'app-reativar-mascara',
  templateUrl: './reativar-mascara.component.html',
  styleUrls: []
})

export class ReativarMascaraComponent implements OnInit, AfterViewInit {
  ...
  reativarMascara() {
    this.mascaraService.ReativarMascara(this.mascara)
      .subscribe(
        result => {
          this.swal.showSwalSuccess('Mascara Reativada com Sucesso');
