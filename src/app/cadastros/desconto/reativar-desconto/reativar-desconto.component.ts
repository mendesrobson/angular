...
@Component({
  selector: 'app-reativar-desconto',
  templateUrl: './reativar-desconto.component.html',
  providers: [MaskService],
  styleUrls: []
})

export class ReativarDescontoComponent implements OnInit, AfterViewInit {
  [x: string]: any;
  ...
  reativarDesconto() {
    this.descontoService.ReativarDesconto(this.desconto)
    .subscribe(
    result => { 
      this.swal.showSwalSuccess('Desconto, reativada com sucesso!');
