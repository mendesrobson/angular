...
@Component({
  selector: 'app-excluir-tipoafastamento',
  templateUrl: './excluir-tipoafastamento.component.html',
  styleUrls: []
})
export class ExcluirTipoafastamentoComponent implements OnInit, AfterViewInit {
  ...
  removerTipoAfastamento() {   
    this.tipoAfastamentoService.removerTipoAfastamento(this.tipoAfastamento)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Tipo de Afastamento removido com sucesso!');            
          } else {
