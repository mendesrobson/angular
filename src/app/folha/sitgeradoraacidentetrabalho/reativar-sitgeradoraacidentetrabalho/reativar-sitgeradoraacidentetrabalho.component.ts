...
@Component({
  selector: 'app-reativar-sitgeradoraacidentetrabalho',
  templateUrl: './reativar-sitgeradoraacidentetrabalho.component.html',
  styleUrls: []
})
export class ReativarSitgeradoraacidentetrabalhoComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    this.swal.showSwalConfirm('Reativação', function (isConfirmed) {
      if (isConfirmed) {
        self.reativarSitGeradoraAcidenteTrabalho();
      }
      else {
        self.cancelar();
      }
  ...
  reativarSitGeradoraAcidenteTrabalho() {
    this.sitGeradoraAcidenteTrabalhoService.reativarSitGeradoraAcidenteTrabalho(this.sitGeradoraAcidenteTrabalho)
      .subscribe(
      result => {
        if (result) {
          this.swal.showSwalSuccess('Situação Geradora do Acidente de Trabalho reativado com sucesso!');
        } else {
  ...
  cancelar() {
    this.router.navigate(['sitgeradoraacidentetrabalho/editar/' + this.sitGeradoraAcidenteTrabalhoId]);
  }
