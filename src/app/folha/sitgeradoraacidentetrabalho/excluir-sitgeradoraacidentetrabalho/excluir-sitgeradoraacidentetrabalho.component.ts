...
@Component({
  selector: 'app-excluir-sitgeradoraacidentetrabalho',
  templateUrl: './excluir-sitgeradoraacidentetrabalho.component.html',
  styleUrls: []
})
export class ExcluirSitgeradoraacidentetrabalhoComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    this.swal.showSwalConfirm('Exclusão', function (isConfirmed) {
      if (isConfirmed) {
        self.removerSitGeradoraAcidenteTrabalho();
      }
      else {
        self.cancelar();
      }
  ...
  removerSitGeradoraAcidenteTrabalho() {   
    this.sitGeradoraAcidenteTrabalhoService.removerSitGeradoraAcidenteTrabalho(this.sitGeradoraAcidenteTrabalho)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Situação Geradora do Acidente de Trabalho removido com sucesso!');            
          } else {
