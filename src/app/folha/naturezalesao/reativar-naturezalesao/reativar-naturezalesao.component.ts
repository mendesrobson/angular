...
@Component({
  selector: 'app-reativar-naturezalesao',
  templateUrl: './reativar-naturezalesao.component.html',
  styleUrls: []
})
export class ReativarNaturezalesaoComponent implements OnInit, AfterViewInit {
  ...
  reativarNaturezaLesao() {
    this.naturezaLesaoService.ReativarNaturezaLesao(this.naturezaLesao)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Natureza da Lesão, Reativado com Sucesso!');
