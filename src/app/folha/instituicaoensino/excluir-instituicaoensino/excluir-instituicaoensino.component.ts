...
@Component({
  selector: 'app-excluir-instituicaoensino',
  templateUrl: './excluir-instituicaoensino.component.html',
  styleUrls: []
})
export class ExcluirInstituicaoensinoComponent implements OnInit, AfterViewInit {
  ...
  constructor(private instituicaoEnsinoService: InstituicaoEnsinoService,
   ...
   removerInstituicaoEnsino() {
       this.instituicaoEnsinoService.RemoverInstituicaoEnsino(this.instituicaoEnsino)
         .subscribe(
           result => {
             if (result) {
               this.swal.showSwalSuccess('Instituição de Ensino, Removido com Sucesso!');
