...
export class AdicionarDepartamentoComponent implements OnInit {
  ...
  adicionarDepartamento() {
    if (this.departamentoForm.dirty && this.departamentoForm.valid) {
      let p = Object.assign({}, this.departamento, this.departamentoForm.value);
      this.DepartamentoService.adicionarDepartamento(p)
        .subscribe(
          result => {
            if (result) {
              this.swal.showSwalSuccess('Departamento adicionado com sucesso!');
