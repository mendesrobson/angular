...
@Component({
  selector: 'app-reativar-contribuicaosindicalpatronal',
  templateUrl: './reativar-contribuicaosindicalpatronal.component.html',
  styleUrls: []
})
export class ReativarContribuicaosindicalpatronalComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    this.swal.showSwalConfirm('Reativação', function (isConfirmed) {
      if (isConfirmed) {
        self.reativarContribuicaoSindicalPatronal();
      }
      else {
        self.cancelar();
      }
  ...
  reativarContribuicaoSindicalPatronal() {
    this.contribuicaoSindicalPatronalService.reativarContribuicaoSindicalPatronal(this.contribuicaoSindicalPatronal)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Contribuição Sindical Patronal, Reativado com Sucesso!');
          } else {
