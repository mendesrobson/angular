...
@Component({
  selector: 'app-reativar-tipojornada',
  templateUrl: './reativar-tipojornada.component.html',
  styleUrls: []
})
export class ReativarTipojornadaComponent implements OnInit, AfterViewInit {
  ...
  reativarTipoJornada() {
    this.tipoJornadaService.reativarTipoJornada(this.tipoJornada)
      .subscribe(
      result => {
        this.swal.showSwalSuccess('Tipo Jornada Reativado com Sucesso');
