...
@Component({
  selector: 'app-editar-agentecausadoracidente',
  templateUrl: './editar-agentecausadoracidente.component.html',
  styleUrls: []
})
export class EditarAgentecausadoracidenteComponent implements OnInit, AfterViewInit {
  ...
  preencherFormAgenteCausadorAcidente(agenteCausadorAcidente: AgenteCausadorAcidente): void {
    ...
    !this.removerVisivel ? this.agenteCausadorAcidenteForm.disable() : this.agenteCausadorAcidenteForm.enable();
  ...
  editarAgenteCausadorAcidente() {
    if (this.agenteCausadorAcidenteForm.dirty && this.agenteCausadorAcidenteForm.valid) {
      ...
      this.agenteCausadorAcidenteService.AtualizarAgenteCausador(p)
        .subscribe(
          result => {
            if (result) {
              this.swal.showSwalSuccess('Agente Causador Acidente, Atualizado com Sucesso!');
  ...
  remover(id) {
    this.router.navigate(['agentecausadoracidente/excluir/' + id]);
  }

  reativar(id) {
    this.router.navigate(['agentecausadoracidente/reativar/' + id]);
  }
