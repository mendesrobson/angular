...
@Component({
  selector: 'app-excluir-agentecausadoracidente',
  templateUrl: './excluir-agentecausadoracidente.component.html',
  styleUrls: []
})
export class ExcluirAgentecausadoracidenteComponent implements OnInit, AfterViewInit {
  ...
  removerNaturezaLesao() {
    this.agenteCausadorAcidenteService.RemoverAgenteCausador(this.agenteCausadorAcidente)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Agente Causador Acidente, Removido com Sucesso!');
