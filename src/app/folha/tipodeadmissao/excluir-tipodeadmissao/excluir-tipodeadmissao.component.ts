...
@Component({
  selector: 'app-excluir-tipodeadmissao',
  templateUrl: './excluir-tipodeadmissao.component.html',
  styleUrls: []
})
export class ExcluirTipodeadmissaoComponent implements OnInit, AfterViewInit {
  ...
  removerTipoDeAdmissao() {   
    this.tipoDeAdmissaoService.removerTipoDeAdmissao(this.tipoDeAdmissao)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Tipo de Admissão removido com sucesso!');            
          } else {
