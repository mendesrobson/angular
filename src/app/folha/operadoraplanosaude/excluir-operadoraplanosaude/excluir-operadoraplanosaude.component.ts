...
@Component({
  selector: 'app-excluir-operadoraplanosaude',
  templateUrl: './excluir-operadoraplanosaude.component.html',
  styleUrls: []
})

export class ExcluirOperadoraPlanoSaudeComponent implements OnInit, AfterViewInit {
  [x: string]: any;
  ...
  ngAfterViewInit(): void {
    ...
    this.swal.showSwalConfirm('Exclusão', function (isConfirmed) {
      if (isConfirmed) {
        self.removerOperadoraPlanoSaude();
      }
      else {
        self.cancelar();
      }
  ...
  removerOperadoraPlanoSaude() {
    this.operadoraPlanoSaudeService.removerOperadoraPlanoSaude(this.operadoraPlanoSaude)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Operadora Plano Saúde Removido com Sucesso!');
          } else {
