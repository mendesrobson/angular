...
@Component({
  selector: 'app-editar-agenteintegrador',
  templateUrl: './editar-agenteintegrador.component.html',
  styleUrls: []
})
export class EditarAgenteintegradorComponent implements OnInit, AfterViewInit {
    ...
    preencherFormAgenteIntegrador(agenteIntegrador: AgenteIntegrador): void {
      ...
      !this.removerVisivel ? this.agenteIntegradorForm.disable() : this.agenteIntegradorForm.enable();
    ...
    editarAgenteIntegrador() {
      if (this.agenteIntegradorForm.dirty && this.agenteIntegradorForm.valid) {
        let p = Object.assign({}, this.agenteIntegrador, this.agenteIntegradorForm.getRawValue());
        
        this.agenteIntegradorService.atualizarAgenteIntegrador(p)
          .subscribe(
          result => {
            this.swal.showSwalSuccess('Agente Integrador, Atualizado com Sucesso');
    ...
    remover(id) {
      this.router.navigate(['agenteintegrador/excluir/' + id]);
    }
  
    reativar(id) {
      this.router.navigate(['agenteintegrador/reativar/' + id]);
    }
