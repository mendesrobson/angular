...
@Component({
  selector: 'app-excluir-agenteintegrador',
  templateUrl: './excluir-agenteintegrador.component.html',
  styleUrls: []
})
export class ExcluirAgenteintegradorComponent implements OnInit, AfterViewInit {
  [x: string]: any;
  ...
  removerAgenteIntegrador() {
    this.agenteIntegradorService.removerAgenteIntegrador(this.agenteIntegrador)
      .subscribe(
        result => {
          this.swal.showSwalSuccess('Agente Integrador, Removido com Sucesso');
