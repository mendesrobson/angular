...
@Component({
  selector: 'app-reativar-cbo',
  templateUrl: './reativar-cbo.component.html',
  styleUrls: []
})

export class ReativarCboComponent implements OnInit , AfterViewInit {
  [x: string]: any;
  ...
  reativarCbo() {
    this.cboService.reativarCbo(this.cbo)
      .subscribe(
      result => {
        this.swal.showSwalSuccess('Cbo Reativado com Sucesso')
