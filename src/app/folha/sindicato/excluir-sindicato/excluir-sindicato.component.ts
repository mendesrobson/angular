...
@Component({
  selector: 'app-excluir-sindicato',
  templateUrl: './excluir-sindicato.component.html',
  styleUrls: []
})
export class ExcluirSindicatoComponent implements OnInit {
  ...
  removerSindicato() {
    this.sindicatoService.removerSindicato(this.sindicato)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Sindicato removido com sucesso!');
          } else {
