...
@Component({
  selector: 'app-excluir-tipohorariotrabalho',
  templateUrl: './excluir-tipohorariotrabalho.component.html',
  styleUrls: []
})
export class ExcluirTipohorariotrabalhoComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    this.swal.showSwalConfirm('Exclusão', function (isConfirmed) {
      if (isConfirmed) {
        self.removerTipoHorarioTrabalho();
      }
      else {
        self.cancelar();
      }
  ...
  removerTipoHorarioTrabalho() {   
    this.tipoHorarioTrabalhoService.removerTipoHorarioTrabalho(this.tipoHorarioTrabalho)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Tipo Horário Trabalho removido com sucesso!');            
          } else {
