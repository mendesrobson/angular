...
@Component({
  selector: 'app-reativar-tipobeneficio',
  templateUrl: './reativar-tipobeneficio.component.html',
  styleUrls: []
})

export class ReativarTipoBeneficioComponent implements OnInit, AfterViewInit {
  ...
  reativarTipoBeneficio() {
    this.tipoBeneficioService.reativarTipoBeneficio(this.tipoBeneficio)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Tipo de Benefício Reativado com Sucesso!');
          } else {
