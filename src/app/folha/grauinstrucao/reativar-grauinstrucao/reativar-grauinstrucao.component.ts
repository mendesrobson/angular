...
@Component({
  selector: 'app-reativar-grauinstrucao',
  templateUrl: './reativar-grauinstrucao.component.html',
  styleUrls: []
})

export class ReativarGrauInstrucaoComponent implements OnInit, AfterViewInit {
  [x: string]: any;
  ...
  reativarGrauInstrucao() {
    this.grauInstrucaoService.reativarGrauInstrucao(this.grauInstrucao)
      .subscribe(
        result => {
          this.swal.showSwalSuccess('Grau Instrução Reativado com Sucesso');
