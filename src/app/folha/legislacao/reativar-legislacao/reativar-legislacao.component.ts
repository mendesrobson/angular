...
@Component({
  selector: 'app-reativar-legislacao',
  templateUrl: './reativar-legislacao.component.html',
  styleUrls: []
})
export class ReativarLegislacaoComponent implements OnInit , AfterViewInit {
  ...
  constructor(
   ...
   preencherFormLegislacao(legislacao: Legislacao): void {
    ...
    reativarLegislacao() {
       this.legislacaoService.ReativarLegislacao(this.legislacao)
         .subscribe(
           result => {
             if (result) {
