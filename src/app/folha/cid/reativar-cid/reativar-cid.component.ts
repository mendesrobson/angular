...
@Component({
  selector: 'app-reativar-cid',
  templateUrl: './reativar-cid.component.html',
  styleUrls: []
})
export class ReativarCidComponent implements OnInit, AfterViewInit {
  ...
  ReativarCid() {
    this.cidService.ReativarCid(this.cid)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Cid, Reativado com Sucesso!');
