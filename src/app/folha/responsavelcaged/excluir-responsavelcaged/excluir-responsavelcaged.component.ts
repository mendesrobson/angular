...
@Component({
  selector: 'app-excluir-responsavelcaged',
  templateUrl: './excluir-responsavelcaged.component.html',
  styleUrls: []
})

export class ExcluirResponsavelcagedComponent implements OnInit, AfterViewInit {
  ...
  removerResponsavelCaged() {   
    this.responsavelCagedService.removerResponsavelCaged(this.responsavelCaged)
      .subscribe(
        result => {
          if (result) {
            this.swal.showSwalSuccess('Responsável Caged removido com sucesso!');            
          } else {
