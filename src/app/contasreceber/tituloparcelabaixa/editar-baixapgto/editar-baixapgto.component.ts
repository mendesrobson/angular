...
@Component({
  selector: 'app-editar-baixapgto',
  templateUrl: './editar-baixapgto.component.html',
  styleUrls: ['./editar-baixapgto.component.css']
})
export class EditarBaixapgtoComponent implements OnInit {
  [x: string]: any;
  ...
  preencherBaixapgto(baixa: BaixaPagarReceberPgto) {
    ...
    this.baixaPgtoForm.patchValue({
      ...
      dataDeposito: this._utilService.ToDate(baixa.chequeFolha.dataDeposito)
    });
  }
