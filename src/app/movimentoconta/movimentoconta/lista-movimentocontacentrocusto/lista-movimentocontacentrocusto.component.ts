...
@Component({
    selector: 'app-lista-movimentocontacentrocusto',
    templateUrl: './lista-movimentocontacentrocusto.component.html'
})
export class ListaMovimentoContaCentroCustoComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        if (this.movimentoContaComponent.MovimentoConta.movimentoContaCentro.length > 0)
            this.data = this.movimentoContaComponent.MovimentoConta.movimentoContaCentro.filter(c => c.centroCusto != null);
    }
    ...
    cadastrarCentroCusto() {
        this.router.navigate(['movimentoconta/adicionarCentroCusto']);
    }
